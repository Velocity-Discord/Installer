...
<style>
    ...
    @keyframes mainLogo {
        from {
            ...
            filter: drop-shadow(0px 0px 0.7px var(--accentGlow));
        }

        to {
            stroke-dashoffset: 800;
            filter: drop-shadow(0px 0px 0 var(--accentGlow));
        }
    }
    @keyframes mainLogoFill {
        0% {
            fill: transparent;
        }
    ...
    #Loader svg path {
        ...
        animation: mainLogo 10s ease, mainLogoFill 8s ease;
